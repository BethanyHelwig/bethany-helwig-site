            ...
            <div className="flex-row">
                ...
                <section aria-label="Book description section">
                    ...
                    <p>A month has passed since Phoenix made her bargain with Dasc—a life debt 
                        ...
                        hunt across Scotland, the fourteen-year search comes to an end, but 
                        Genna Barnes isn’t what anyone expects.</p>
                    <p>When Genna’s loyalties are brought into question, Phoenix is given orders 
                        to shadow Jefferson’s daughter while keeping those closest to her in the 
                        dark. Forced to toe a precarious line, Phoenix tries to balance doing her 
                        job and safeguarding Jefferson’s happiness. But Genna isn’t her only concern. 
                        Magical sanctuaries are under attack around the globe, the agent trials 
                        loom in the future, and she has more than a few secrets to protect.</p>
                    <p>As if that weren’t enough, startling revelations bring everything she knows 
